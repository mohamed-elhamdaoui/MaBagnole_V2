        ...
        <main class="flex-1 p-6 md:p-12">
            <div class="max-w-6xl mx-auto">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="#" class="bg-gray-900 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:bg-red-600 transition text-xs uppercase tracking-widest flex items-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 flex flex-col overflow-hidden group">
                        <div class="h-48 bg-gray-200 relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&q=80&w=800" alt="Car" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            <div class="flex items-center gap-2 mb-3">
                                <span class="text-red-600 text-xs font-bold uppercase tracking-widest">Conseils</span>
                                <span class="text-gray-300 text-xs">•</span>
                                <span class="text-gray-400 text-xs font-semibold">12 Jan 2024</span>
                            </div>
                            <h3 class="font-bold text-xl text-gray-900 mb-3 leading-tight group-hover:text-red-600 transition">
                                Comment bien entretenir sa voiture en hiver ?
                            </h3>
                            <p class="text-gray-500 text-sm leading-relaxed mb-6 line-clamp-2">
                                L'hiver arrive à grands pas. Voici nos 5 conseils essentiels pour préparer votre véhicule et rouler en toute sécurité.
                            </p>
