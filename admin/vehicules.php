...
<body class="bg-gray-50 font-sans">
    ...
    <div id="addVehiculeModal" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-[40px] p-10 max-w-2xl w-full shadow-2xl modal-animate">
            ...
            <form action="../actions/add_vehicule.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 tracking-widest">Modèle</label>
                        <input type="text" name="modele" required placeholder="Ex: Tesla Model 3..." 
                               class="w-full p-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-red-500 outline-none font-bold text-gray-700">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 tracking-widest">Prix par jour (€)</label>
                        <input type="number" step="0.01" name="prix_par_jour" required placeholder="Ex: 45.00" 
                               class="w-full p-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-red-500 outline-none font-bold text-gray-700">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="image" placeholder="Lien vers l'image" 
